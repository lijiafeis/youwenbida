...
<div id="aw-side" class="aw-side ps-container">
    ...
    <div class="aw-content-wrap">
        <form  enctype="multipart/form-data" method="post" id="category_form"
               action="<?php echo U('Admin/Category/edit',['id' => $cat['cat_id']]);?>" >
            <input type="hidden" value="<?php echo ($cat['cat_logo']); ?>" name="old_cat_logo">
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5 col-xs-8">
                                        <?php if($cat['cat_logo'] != ''): ?><img src = "/phpStorm/youwenbida/Public/upload/<?php echo ($cat['cat_logo']); ?>" width = '50px'>
                                            <br>

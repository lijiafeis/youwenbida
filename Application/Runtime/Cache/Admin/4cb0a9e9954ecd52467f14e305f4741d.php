...
<div id="aw-side" class="aw-side ps-container">
    ...
    <div class="aw-content-wrap">
        <form enctype="multipart/form-data"  method="post" id="settings_form"
              action="<?php echo U('edit');?>">
            <input type="hidden" value="<?php echo ($topic_info['topic_id']); ?>" name="topic_id">
            <input type= "hidden" value = "<?php echo ($topic_info['topic_thumb']); ?>" name = "topic_thumb">
            <div class="mod">
                <div class="mod-head">
                    <h3>
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5 col-xs-8">
                                        <?php if($topic_info['topic_thumb'] != ''): ?><img src = "/phpStorm/youwenbida/Public/upload/<?php echo ($topic_info['topic_thumb']); ?>">
                                            <span style = 'color:red'>再次上传会覆盖</span>
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5 col-xs-8">
                                        <input type="text" class="form-control" value="<?php echo ($topic_info['topic_title']); ?>" name="topic_title">
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5 col-xs-8">
                                        <textarea name="topic_desc" class="form-control"><?php echo ($topic_info['topic_desc']); ?></textarea>
                                    </div>
                                </div>
                            </td>
                        </tr>
